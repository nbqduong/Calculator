...
class HyperbolicLnPluginCommand : public Cal::PluginCommand
{
public:
...
class HyperbolicLnPlugin : public Cal::Plugin
{
public:
    HyperbolicLnPlugin();
...
private:
    ...
    Cal::Plugin::ApiVersion apiVersion() const override { return {1, 0}; }

    void createPluginDescriptor();
    void createPluginButtonDescriptor();

    Cal::Plugin::PluginDescriptor pd_;
    vector<Cal::Command*> rawCommands_;
    vector<unique_ptr<Cal::Command>> commands_;
...
{
    auto d = static_cast<Cal::Plugin*>(p);
    delete d;
}